...
#### 1.安装
    ...
    git clone https://github.com/cr3hf/shadowsocksr.git

或者通过wget下载

    wget https://github.com/cr3hf/shadowsocksr/archive/master.zip && unzip master && mv shadowsocksr-master shadowsocksr
